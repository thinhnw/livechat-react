...
const Login = () => {
  ...
  return (
    <div className="h-screen flex items-center relative justify-center">
      {/* <div className="rounded-full bg-violet-400 w-20 h-20 relative flex justify-center items-center mx-auto">
        <svg
      ...
      <h2 className="block w-full text-center font-bold text-5xl">Live Chat</h2> */}
      <form
